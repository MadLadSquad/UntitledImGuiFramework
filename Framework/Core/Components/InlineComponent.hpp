...
{
    /**
     * @brief A component that directly draws to the window's frame-buffer(the opposite of the WindowComponent)
     * @implements InlineComponent - The constructor for the component
     ...
     * @static make - Creates an InlineComponent of a given subclass type
    ...
    public:
         ...
         */
        static constexpr ComponentType componentType = UIMGUI_COMPONENT_TYPE_INLINE;
        /**
