...
if (BUILD_VARIANT_VENDOR)
    foreach(f IN ITEMS ${ENABLED_LIBRARIES})
        # Vendored libraries are real targets(added with add_subdirectory), so we can read their definitions directly.
        # An unset COMPILE_DEFINITIONS property evaluates to "<var>-NOTFOUND", which must not be forwarded verbatim.
        if (TARGET ${f})
